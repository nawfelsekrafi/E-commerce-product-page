...
nextImageBtn.addEventListener("click", function () {
  if (currentImg < 3) {
    currentImg++;
    document.getElementById("gallery-main-2").src =
...
var closeMenuModalBtn = document.getElementById('close-menu-modal');

closeMenuModalBtn.addEventListener('click', function(){
    document.getElementById('menu-mobile-modal').style.display='none';
})
var openMenuModalBtn = document.getElementById('list-icon');

openMenuModalBtn.addEventListener('click', function(){
    document.getElementById('menu-mobile-modal').style.display='block';
})